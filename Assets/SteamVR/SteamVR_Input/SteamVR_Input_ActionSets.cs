...
namespace Valve.VR
{
    ...
    public partial class SteamVR_Actions
    {
        ...
        private static SteamVR_Input_ActionSet_Scene1_ButtonAnswer p_Scene1_ButtonAnswer;
        ...
        public static SteamVR_Input_ActionSet_Scene1_ButtonAnswer Scene1_ButtonAnswer
        {
            get
            {
                return SteamVR_Actions.p_Scene1_ButtonAnswer.GetCopy<SteamVR_Input_ActionSet_Scene1_ButtonAnswer>();
            }
        }
        ...
        private static void StartPreInitActionSets()
        {
            ...
            SteamVR_Actions.p_Scene1_ButtonAnswer = ((SteamVR_Input_ActionSet_Scene1_ButtonAnswer)(SteamVR_ActionSet.Create<SteamVR_Input_ActionSet_Scene1_ButtonAnswer>("/actions/Scene1_ButtonAnswer")));
            Valve.VR.SteamVR_Input.actionSets = new Valve.VR.SteamVR_ActionSet[] {
                    SteamVR_Actions._default,
                    SteamVR_Actions.platformer,
                    SteamVR_Actions.buggy,
                    SteamVR_Actions.mixedreality,
                    SteamVR_Actions.Scene1_ButtonAnswer};
        }
    }
}
